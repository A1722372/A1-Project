-- [[ سكريبت أيهم الأسطوري V12 - النسخة المصلحة والشغالة 100% ]]
...
-- نظام ألوان الشرائح والقوائم الكامل
...
-- القائمة الجانبية للتنقل مع الـ Scroll Bar المصلح بالكامل
local SideMenu = Instance.new("ScrollingFrame", MainFrame)
SideMenu.Size = UDim2.new(0, 130, 1, -35) 
SideMenu.Position = UDim2.new(0, 0, 0, 35)
SideMenu.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
SideMenu.BorderSizePixel = 0
SideMenu.CanvasSize = UDim2.new(0, 0, 0, 260)
SideMenu.ScrollBarThickness = 5
SideMenu.ScrollBarColor3 = Color3.fromRGB(255, 200, 0) -- التعديل الصحيح هنا لقفل المشكلة بالكامل
...
for i, name in ipairs(tabs) do
    ...
    btn.Position = UDim2.new(0.05, 0, 0, (i-1) * 38 + 8)
    btn.Text = name 
...
FlyBtn.Text = "تفعيل الطيران السهل (Fly)" 
...
local function updateCPList()
    ...
    for name, cframe in pairs(savedLocations) do
        ...
        GoBtn.Text = name
        GoBtn.BackgroundColor3 = Color3.fromRGB(45, 45, 45) 
...
SaveBtn.Size = UDim2.new(0.3, 0, 0, 32) 
SaveBtn.Position = UDim2.new(0.65, 0, 0, 10)
SaveBtn.Text = "حفظ" 
...
local function giveDirectEffect(effectType, customColor)
    ...
    elseif effectType == "Particles" then
        ...
        pe.Name = "PlayerParticles" 
        pe.Color = ColorSequence.new(customColor)
        pe.Speed = NumberRange.new(8, 12) 
        pe.Rate = 80 
...
createEffectBtn("تفعيل شظايا اللهب المصلحة (Red Particles)", 124, Color3.fromRGB(190, 0, 0), function() giveDirectEffect("Particles", Color3
