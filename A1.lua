-- [[ سكريبت أيهم الأسطوري V16 (الكامل) ]]
...
SideMenu.CanvasSize = UDim2.new(0, 0, 0, 360)
...
SpeedBtn.MouseButton1Click:Connect(function()
    ...
    if speedActive then Player.Character.Humanoid.WalkSpeed = tonumber(SpeedInput.Text) or 65
...
GhostBtn.MouseButton1Click:Connect(function()
    ...
    if ghostActive then
        ...
        RunService.RenderStepped:Connect(function()
            if ghostActive and ghostChar then ghostChar.Humanoid:Move(char.Humanoid.MoveDirection, true) end
        end)
    else
