-- [[ سكريبت Anxam الأسطوري - النسخة V41.6 الأصلية مع تعديل السكرول ]]
...
for i, name in ipairs(MenuConfig) do
    ...
    page.Visible = (i == 1)
    page.ScrollBarThickness = 6 -- إظهار شريط التمرير الرمادي بشكل واضح
...
-- ==================== تبويب اللاعب (مصلح بالكامل) ====================
local PlayerPage = AllPages["اللاعب"]
PlayerPage.CanvasSize = UDim2.new(0, 0, 0, 370) -- تحديد النطاق الفعلي لتشغيل السكرول التلقائي بالملي
